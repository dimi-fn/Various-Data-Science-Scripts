...
* Ιn the CSV directory, a [CSV file provided by Moz.com](https://github.com/dimi-fn/Various-Data-Science-Scripts/tree/main/SEO/csv/moz) can additionally be found with regard to the query "Artificial Intelligence", and how [Moz.com](moz.com) aggregates the keyword results and metrics.
