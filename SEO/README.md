...
"*Google searches are the most important dataset ever collected on the human psyche*". By that he means that, in the context of Big Data, and by collecting and analyzing data derived from Google searches, we can analyze -and even predict- people's behaviour: needs, trends, motivations.
