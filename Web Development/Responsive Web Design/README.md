...
* `main`, `header`, `footer`, `nav`, `video`, `article`, `section`, and others
    * `main`: The [main](https://www.w3schools.com/tags/tag_main.asp#:~:text=Definition%20and%20Usage&text=Note%3A%20There%20must%20not%20be,main%3E%20element%20in%20a%20document.) HTML5 tag helps search engines and other developers find the main content of your website
