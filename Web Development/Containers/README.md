...
| `docker system prune -a`| clean up as much as possible excluding components that are in use |
|`docker system prune` | clean up most Docker resources but still keep tagged images |
