...
def solution(x):
    ...
    # occurrence of only negative numbers existed: then return 1 automatically
    if max(x) <= 0:
        return 1

    # List contains positive numbers
    # Sorting the list and then keep only the positive numbers
    x.sort()
...
class Test_solution(unittest.TestCase):
    ...
    def test_case7(self):
        ...
        validation= solution(given_input)
        self.assertEqual(validation, 1001)
